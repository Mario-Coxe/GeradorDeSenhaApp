...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Gerando Senha</Text>
      <Text style={styles.subHeader}>Gerador de Senha Aleatória</Text>

      <View style={styles.inputContainer}>
        <Text style={styles.label}>Comprimento da Senha:</Text>
        <TextInput
